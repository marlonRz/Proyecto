...
Dolor abdominal (tipo cólico), Diarrea persistente (a veces con sangre), Fatiga y debilidad, Pérdida de peso sin razón aparente, Fiebre ocasional, Náuseas o vómitos, Aftas en la boca, Inflamación en las articulaciones, piel u ojos (síntomas extraintestinales)`],
    ...
    titulo: 'TRATAMIENTO',
    descripcion: [
      'Medicamentos antiinflamatorios (como mesalazina o corticoides), inmunosupresores, terapias biológicas, cirugía en casos severos'
    ],
    objeto3D: <TreatmentCrohn position={[0, -0.8, 0]} scale={[1, 1, 1]} />,
    light: <pointLight color={"blue"} position={[0, 3, 3]} intensity={3} castShadow={true}/>,
    staging: null
